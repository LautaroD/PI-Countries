    ...
    return (
        <div className={style.container}>
            ...
            <div className={style.containerLogo}>
                <a className={style.ingreso} href="/home"><button href='/home' className={style.btnEntrar}>Entrar</button></a>
            </div>
            {/* <img className={style.imgBg} alt='Welcome' src={backgroundImage} /> */}
        </div>
    )
}
    //  <div className={style.container}>
